...
from info import AUTH_CHANNEL, LONG_IMDB_DESCRIPTION, MAX_LIST_ELM, SHORT_URL, SHORT_API, VERIFY, SUPPORT_CHAT
            ...
            await bot.send_cached_media(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        ...
                        InlineKeyboardButton('Uᴘᴅᴀᴛᴇs Cʜᴀɴɴᴇʟ', url=AUTH_CHANNEL)
                    ],[
                        InlineKeyboardButton("Bᴏᴛ Oᴡɴᴇʀ", url="https://t.me/Hatmateinc")
                        ]
                    ]
                )
            )
